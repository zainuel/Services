...
/**
 * Created by ZAINUEL on 4/19/2017.
 */
...
public class CustomGridView extends BaseAdapter {
    ...
    public CustomGridView(Context context, String[] gridViewString, int[] gridViewImageId,String[] gridcolor) {
        mContext = context;
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            gridViewAndroid.setBackgroundColor(Color.parseColor(gridcolor[i]));
